...
<h2 id="h2"><b><img id="imgCartabloccata" src="img/cartaBloccata.jpg"
			alt="Immagine cata bloccata"> Carta Bloccata! </b></h2>
<hr>
<div id="p">
<h3><b> Operazione riuscita </b></h3>
<p><b> La carta <span>${carta.nome} - ${carta.numero}</span> è stata bloccata! </b></p>
<br>
