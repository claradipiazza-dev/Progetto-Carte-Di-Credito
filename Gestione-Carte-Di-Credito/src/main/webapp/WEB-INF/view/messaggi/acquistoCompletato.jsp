...
<h2 id="h2"><b><img id="imgAcquisto" src="img/acquistoCarte.jpg"
			alt="Immagine acquisto carta"> Grazie per il tuo acquisto! </b></h2>
			<hr>
<p style="font-size: 33px;"><b> Il tuo pagamento è andato a buon fine! </b></p>
<div id="p">
<p><b> Nome carta acquistata:<span> ${nomeCarta} </span></b></p>
<p><b> Nome carta pagamento:<span>${cartautente.nome} </span></b></p>
<p><b> Credito carta pagamento: <span>&euro; ${creditoAggiornato.credito} </span></b></p>
<br>
<a type="button" role="button" class="btn btn-danger btn-lg" href="Home">&lt;&lt; Ritorna all'home </a><br>
</div>
</div>
